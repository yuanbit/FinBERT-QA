...
anserini/target/appassembler/bin/SearchMsmarco  -hits 500 -threads 1 \
 -index retrieval/lucene-index-fiqa -qid_queries retrieval/train/train_questions.tsv \
 -output retrieval/train/cands_train_500.tsv
...
anserini/target/appassembler/bin/SearchMsmarco  -hits 500 -threads 1 \
 ...
 -output retrieval/test/cands_test_500.tsv
...
anserini/target/appassembler/bin/SearchMsmarco  -hits 500 -threads 1 \
 ...
 -output retrieval/valid/cands_valid_500.tsv
